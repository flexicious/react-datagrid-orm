        ...
        if (isFilterExpression(filterExpression)) {
            ...
            switch (operation) {
                ...
                case FilterOperation.InList:
                    const inListExpression = expression as Primitive[];
                    queryBuilder = queryBuilder.whereIn(column, inListExpression);
                    break;
                case FilterOperation.NotInList:
                    const notInListExpression = expression as Primitive[];
                    queryBuilder = queryBuilder.whereNotIn(column, notInListExpression);
                    break;
